...
<div class="color">
                ...
                <div class="check">
                <input type="checkbox" required="true"> <p class="check">Eu concordo com os termos do ODISSEIA.</p><br>
                <input type="checkbox" required="true"> <p class="check">Eu aceito receber notificações do ODISSEIA no meu e-mail.</p>
                </div>
<center>
