        ...
        <table class="table table-striped">
            ...
            ?>
                <tr><td><?php echo $linha['idastro'];?></td>
                    ...
                    <td><a href='cadastrofoto.php?idastro=<?php echo $linha['idastro'];?>&processo=editar'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-wrench" viewBox="0 0 16 16">
