...
<?php
    ...
    if ($processo == 'editar'){
        ...
        if ($idastro > 0){
            $dados = Astrofotografia::Listar(1, $idastro);
...
<body>
    ...
    <section>
        ...
        <div><input name="idastro" id="idastro" type="hidden" required="true" value="<?php if ($processo = "editar"){echo $idastro;}?>"></div>    

        <p class = "titulo1" style="text-transform: uppercase; font-size: 220%; margin-top: 2.3%; ">NOME: <input name = "nome_astro" id = "nome_astro" required = "true" value="<?php if ($processo == "editar"){echo $dados[0]['nome_astro'];}?>"></p>
        ...
        <div class="color2" style="overflow-y: scroll; border-radius: 5px; margin-top: -39%; background: #8C3001;">
            ...
            <div>
                ...
                <textarea name="equipamento" required = "true" style="font-size: 100%; padding-top: 1%; padding-left: 1%; border-radius: 5px; color: white; height: 100%; width: 100%;  border: none; background-color: #BC5357; font-family: 'Hammersmith One', sans-serif; maxx; resize: none;"><?php if ($processo = "editar"){echo $dados[0]['equipamento'];}?></textarea>
            </div>         
        </div>
        ...
        <div class="color3" style="overflow-y: scroll; background: #8C3001; margin-top: 0.5%; border-radius: 5px;">
            ...
            <p style="text-transform: uppercase; font-size: 150%" class="titulo2">Detalhes de Captura</p><br><br>
                <textarea name="detalhes" required = "true" style="font-size: 100%; padding-top: 1%; padding-left: 1%; border-radius: 5px; color: white; height: 100%; width: 100%; border: none; background-color: #BC5357; font-family: 'Hammersmith One', sans-serif; maxx; resize: none;"><?php if ($processo = "editar"){echo $dados[0]['detalhes'];}?></textarea>
            </div>
        </div>
        <div class="color3" style="overflow-y: scroll; background: #8C3001; margin-top: 0.5%; border-radius: 5px;">
            <div>
            <p style="text-transform: uppercase; font-size: 150%; margin-bottom: 10%" class="titulo2">ADICIONAR IMAGEM</p><br>
            <input required = "true" style="color: white; font-family: 'Hammersmith One', sans-serif; margin-top: -2%" name="ficheiro" id="ficheiro" type="file" value="<?php if ($processo == "editar"){echo $dados[0]['ficheiro'];}?>"></div>
            </div>
            <input class="form-control" style="max-width:20%"  name="idusuario" id="idusuario" type="hidden" required="true" placeholder="Insira a detalhes" value="<?php if ($processo == "editar"){echo $dados[0]['idusuario'];} else { echo $id; }?>">        
        </div>
            </div>
        </form>
    </div>
