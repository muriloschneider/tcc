...
<?php
    ...
    $id = isset($_POST['idastro']) ? $_POST['idastro'] : 0;
    ...
    if ($processo == 'editar'){
        $id = isset($_GET['idastro']) ? $_GET['idastro'] : "";
        if ($id > 0){
            $astro = new Astrofotografia("","", "", "", "", "");
            $dados = $astro->listar(1, $id);
        }
    }
    ?>
...
<body>
    <div class="container-fluid">
        ...
        <form method="post" action="../controle/processaII.php">
            <input class="form-control" readonly  style="max-width:20%" type="hidden" name="idastro" id="" value="<?php if($processo == "editar"){echo $dados[0]['idastro'];}?>"><br>
            Adicionar Ficheiro: <input class="form-control" style="max-width:20%"  name="ficheiro" id="ficheiro" type="file" required="true" value="<?php if ($processo == "editar"){echo $dados[0]['ficheiro'];}?>"><br>         
            ...
            Detalhes: <input class="form-control" style="max-width:20%"  name="detalhes" id="detalhes" type="text" required="true" placeholder="Insira a detalhes" value="<?php if ($processo == "editar"){echo $dados[0]['detalhes'];}?>"><br>         
            <br>
                <br>
                <br>   
